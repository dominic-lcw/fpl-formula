...
export function PlayerRankSearch({ rankings, pinnedPlayer, onSelectRank, onPinPlayer }: PlayerRankSearchProps) {
  ...
  useEffect(() => {
    ...
    setSuggestions(searchRankedPlayers(rankings, trimmedQuery));
    setIsOpen(true);
  }, [query, rankings]);
